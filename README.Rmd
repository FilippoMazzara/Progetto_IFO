...
## Basic Usage
When GeneApp starts you will be greeted by the home page from where you can start navigating the app. To close the application close the browser window and then click `Stop`. The GeneApp process will stop and the browser window will close (Chrome) or gray-out.
...
so I will quickly go over them. 
   ...
   - Both in the main panel and in the statistics panel you will find some useful and interactive stats and plots.
...
In the Help page you will find more helpful tips and the app's guide.
